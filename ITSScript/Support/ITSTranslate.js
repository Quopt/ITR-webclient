...
var ITSSupportedLanguages = [ // these are internal ITS language codes, not the browser supported ones
    {languageCode: "af", languageDescription: "Afrikaans"},
    {languageCode: "ar", languageDescription: "Arabic"},
    {languageCode: "bn", languageDescription: "Bangla"},
    {languageCode: "bs", languageDescription: "Bosnian (Latin)"},
    {languageCode: "bg", languageDescription: "Bulgarian"},
    {languageCode: "yue", languageDescription: "Cantonese (Traditional)"},
    {languageCode: "ca", languageDescription: "Catalan"},
    {languageCode: "zh-Hans", languageDescription: "Chinese Simplified"},
    {languageCode: "hr", languageDescription: "Croatian"},
    {languageCode: "cs", languageDescription: "Czech"},
    {languageCode: "da", languageDescription: "Danish"},
    {languageCode: "nl", languageDescription: "Dutch"},
    {languageCode: "en", languageDescription: "English"},
    {languageCode: "et", languageDescription: "Estonian"},
    {languageCode: "fj", languageDescription: "Fijian"},
    {languageCode: "fil", languageDescription: "Filipino"},
    {languageCode: "fi", languageDescription: "Finnish"},
    {languageCode: "fr", languageDescription: "French"},
    {languageCode: "frr", languageDescription: "Frisian"},
    {languageCode: "de", languageDescription: "German"},
    {languageCode: "el", languageDescription: "Greek"},
    {languageCode: "ht", languageDescription: "Haitian Creole"},
    {languageCode: "he", languageDescription: "Hebrew"},
    {languageCode: "hi", languageDescription: "Hindi"},
    {languageCode: "mww", languageDescription: "Hmong Daw"},
    {languageCode: "hu", languageDescription: "Hungarian"},
    {languageCode: "id", languageDescription: "Indonesian"},
    {languageCode: "it", languageDescription: "Italian"},
    {languageCode: "ja", languageDescription: "Japanese"},
    {languageCode: "sw", languageDescription: "Kiswahili"},
    {languageCode: "tlh", languageDescription: "Klingon"},
    {languageCode: "ko", languageDescription: "Korean"},
    {languageCode: "lv", languageDescription: "Latvian"},
    {languageCode: "lt", languageDescription: "Lithuanian"},
    {languageCode: "mg", languageDescription: "Malagasy"},
    {languageCode: "ms", languageDescription: "Malay"},
    {languageCode: "mt", languageDescription: "Maltese"},
    {languageCode: "nb", languageDescription: "Norwegian"},
    {languageCode: "fa", languageDescription: "Persian"},
    {languageCode: "pl", languageDescription: "Polish"},
    {languageCode: "pt", languageDescription: "Portuguese"},
    {languageCode: "otq", languageDescription: "Queretaro Otomi"},
    {languageCode: "ro", languageDescription: "Romanian"},
    {languageCode: "ru", languageDescription: "Russian"},
    {languageCode: "sm", languageDescription: "Samoan"},
    {languageCode: "sr-Cyrl", languageDescription: "Serbian (Cyrillic)"},
    {languageCode: "sr-Latn", languageDescription: "Serbian (Latin)"},
    {languageCode: "sk", languageDescription: "Slovak"},
    {languageCode: "sl", languageDescription: "Slovenian"},
    {languageCode: "es", languageDescription: "Spanish"},
    {languageCode: "sv", languageDescription: "Swedish"},
    {languageCode: "ty", languageDescription: "Tahitian"},
    {languageCode: "ta", languageDescription: "Tamil"},
    {languageCode: "th", languageDescription: "Thai"},
    {languageCode: "to", languageDescription: "Tongan"},
    {languageCode: "tr", languageDescription: "Turkish"},
    {languageCode: "uk", languageDescription: "Ukrainian"},
    {languageCode: "ur", languageDescription: "Urdu"},
    {languageCode: "vi", languageDescription: "Vietnamese"},
    {languageCode: "cy", languageDescription: "Welsh"},
    {languageCode: "yua", languageDescription: "Yucatec Maya"}
]
