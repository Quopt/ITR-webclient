...
// add the portlet at the proper place, add portlet.html to AdminInterfacePortlets
    ...
    ITSScreenTemplateLocalPublisherEditor.prototype.fireRequest = function () {
        ...
        ITSInstance.JSONAjaxLoader('screentemplates' , this.templatesList, this.listLoaded.bind(this), this.listLoadingFailed.bind(this), 'ITSScreenTemplate', this.currentPage, 25,
